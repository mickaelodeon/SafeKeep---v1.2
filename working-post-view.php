<?php
/**
 * Working Post View with Contact Form
            ...
            try {
                ...
                if ($contactId) {
                    ...
                    $emailBody = "
                        ...
                        <p><a href='http://localhost/safekeep-v2/posts/working-view.php?id=" . $postId . "'>View your post on SafeKeep</a></p>
                    ";
...
try {
    ...
    if (!$post) {
        header('Location: /safekeep-v2/show-posts.php');
        exit;
    }
} catch (Exception $e) {
    $error = $e->getMessage();
    ...
    <div class="container my-4">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/safekeep-v2/show-posts.php">Browse Items</a></li>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <div class="card mt-3">
                    <div class="card-body text-center">
                        <a href="/safekeep-v2/show-posts.php" class="btn btn-secondary">
